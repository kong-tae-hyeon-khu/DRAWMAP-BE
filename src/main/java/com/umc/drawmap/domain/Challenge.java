...
public class Challenge extends BaseEntity {
    ...
    public Challenge update(String challengeCourseTitle, String sido, String sgg, Difficulty challengeCourseDifficulty, String challengeCourseContent, String challengeImage){
